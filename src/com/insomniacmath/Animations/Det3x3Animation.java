    ...
    public void tic(int t) {
        switch (t) {
            ...
            case 1:
                ...
                break;
            case 2:
                solvationTexts[0].setText("+ " + Utils.bra(mW1.m[0][0], true) + "*" + Utils.bra(mW1.m[1][1], true));
                mW1.getCanvas().addPath(0, 0, 1, 1, cyan);
                mW1.getCanvas().addCircle(1, 1, cyan);
                break;
            case 3:
                solvationTexts[0].setText("+ " + Utils.bra(mW1.m[0][0], true) + "*" + Utils.bra(mW1.m[1][1], true) + "*" + Utils.bra(mW1.m[2][2], true));
            ...
            case 6:
                solvationTexts[1].setText("+ " + Utils.bra(mW1.m[0][1], true));
                mW1.getCanvas().addCircle(1, 0, viol);
                break;
            case 7:
                solvationTexts[1].setText("+ " + Utils.bra(mW1.m[0][1], true) + "*" + Utils.bra(mW1.m[1][2], true));
                mW1.getCanvas().addPath(1, 0, 2, 1, viol);
                mW1.getCanvas().addCircle(2, 1, viol);
                break;
            case 8:
                solvationTexts[1].setText("+ " + Utils.bra(mW1.m[0][1], true) + "*" + Utils.bra(mW1.m[1][2], true) + "*" + Utils.bra(mW1.m[2][0], true));
            ...
            case 10:
                ...
                break;
            case 11:
                solvationTexts[2].setText("+ " + Utils.bra(mW1.m[1][0], true));
                mW1.getCanvas().addCircle(0, 1, ros);
                break;
            case 12:
                solvationTexts[2].setText("+ " + Utils.bra(mW1.m[1][0], true) + "*" + Utils.bra(mW1.m[2][1], true));
                mW1.getCanvas().addPath(0, 1, 1, 2, ros);
                mW1.getCanvas().addCircle(1, 2, ros);
                break;
            case 13:
                solvationTexts[2].setText("+ " + Utils.bra(mW1.m[1][0], true) + "*" + Utils.bra(mW1.m[2][1], true) + "*" + Utils.bra(mW1.m[0][2], true));
            ...
            case 16:
                ...
                break;
            case 17:
                solvationTexts[3].setText("- " + Utils.bra(mW1.m[0][2], true));
                mW1.getCanvas().addCircle(2, 0, blu);
                break;
            case 18:
                solvationTexts[3].setText("- " + Utils.bra(mW1.m[0][2], true) + "*" + Utils.bra(mW1.m[1][1], true));
                mW1.getCanvas().addPath(2, 0, 1, 1, blu);
                mW1.getCanvas().addCircle(1, 1, blu);
                break;
            case 19:
                solvationTexts[3].setText("- " + Utils.bra(mW1.m[0][2], true) + "*" + Utils.bra(mW1.m[1][1], true) + "*" + Utils.bra(mW1.m[2][0], true));
            ...
            case 21:
                solvationTexts[4].setText("- " + Utils.bra(mW1.m[0][1], true));
                mW1.getCanvas().addCircle(1, 0, gree);
                break;
            case 22:
                solvationTexts[4].setText("- " + Utils.bra(mW1.m[0][1], true) + "*" + Utils.bra(mW1.m[1][0], true));
                mW1.getCanvas().addPath(1, 0, 0, 1, gree);
                mW1.getCanvas().addCircle(0, 1, gree);
                break;
            case 23:
                solvationTexts[4].setText("- " + Utils.bra(mW1.m[0][1], true) + "*" + Utils.bra(mW1.m[1][0], true) + "*" + Utils.bra(mW1.m[2][2], true));
            ...
            case 26:
                solvationTexts[5].setText("- " + Utils.bra(mW1.m[1][2], true));
                mW1.getCanvas().addCircle(2, 1, yel);
                break;
            case 27:
                solvationTexts[5].setText("- " + Utils.bra(mW1.m[1][2], true) + "*" + Utils.bra(mW1.m[2][1], true));
                mW1.getCanvas().addPath(2, 1, 1, 2, yel);
                mW1.getCanvas().addCircle(1, 2, yel);
                break;
            case 28:
                solvationTexts[5].setText("- " + Utils.bra(mW1.m[1][2], true) + "*" + Utils.bra(mW1.m[2][1], true) + "*" + Utils.bra(mW1.m[0][0], true));
